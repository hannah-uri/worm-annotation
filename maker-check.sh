...
maker -CTL
cat maker_opts.ctl | sed 's/^genome=.*$/genome=ref\/c_elegans.PRJEB28388.WS274.genomic.fa /' | sed 's/^est=.*$/est=ref\/c_elegans.PRJEB28388.WS274.mRNA_transcripts.fa /' | sed 's/^model_org=.*$/model_org= /' > maker_opts.ctl
